    ...
    */
    ...
    'connections' => [
        ...
        'sqlite' => [
            ...
            // SQLite ignores lockForUpdate(), so the registration counter is
            // protected by taking the write lock at BEGIN instead. busy_timeout
            // makes a second writer wait rather than fail with "database is
            // locked". Neither setting is needed on MySQL.
