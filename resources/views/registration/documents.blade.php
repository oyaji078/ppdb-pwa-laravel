...
@section('wizard')
    <div class="card p-6 sm:p-8">
        ...
        <p class="mt-1 text-sm text-slate-600">
            Unggah seluruh berkas wajib untuk jalur <span class="font-semibold">{{ $registration->admissionTrack->name }}</span>.
        ...
        @else
            <ul class="mt-6 space-y-4">
                @foreach ($documentTypes as $type)
                    ...
                    <li class="rounded-lg border border-slate-200 p-4 sm:p-5">
        ...
        <div class="mt-8 flex flex-col gap-3 border-t border-slate-100 pt-6 sm:flex-row sm:justify-between">
            ...
            <a href="{{ route('registration.review') }}" class="btn-primary">
                Lanjut ke Review
